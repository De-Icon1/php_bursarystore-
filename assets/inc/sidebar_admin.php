<?php
// Sidebar for admin/dashboard pages
...
<div class="left-side-menu">
	<div class="slimscroll-menu">
		...
		<div class="user-box text-center">
			...
			<div class="dropdown">
				<a href="#" class="text-dark h5 mt-2 mb-1 d-block"><?php echo htmlspecialchars($_SESSION['full_name'] ?? ''); ?></a>
			...
			<ul class="metismenu" id="side-menu">
				...
				<li class="has-submenu">
					...
					<ul class="nav-second-level" aria-expanded="false">
						...
						<li><a href="stationery_store.php">Stationery Store</a></li>
				...
				<li class="has-submenu">
					...
					<ul class="nav-second-level" aria-expanded="false">
						...
						<li><a href="inventory_grouped.php">Grouped Items (Paper & Toners)</a></li>
